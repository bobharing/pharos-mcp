          ...
          text: JSON.stringify(
            {
              ...
              inp: {
                ...
                note: "INP replaced FID as a Core Web Vital in March 2024. In lab testing, TBT is used as a proxy.",
              },
              cls: {
        ...
        text: JSON.stringify(
          {
            ecommerce: {
              ...
              budgets: {
                ...
                inp: { target: 200, warning: 500, critical: 1000, unit: "milliseconds" },
