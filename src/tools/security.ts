...
export function registerSecurityTools(server: McpServer) {
  server.registerTool(
    ...
    {
      description:
        "Security audit: HTTPS, mixed-content, HSTS, and CSP. Reads from cache if pharos_audit ran first. Note: https/mixed-content/hsts all map to the same is-on-https audit.",
